...
export function useTaskHubConnection() {
    return useContext(SignalRContext);
}

// Хук для подписки на событие
export function useTaskHubEvent<TArgs extends any[] = any[]>(
    event: string,
