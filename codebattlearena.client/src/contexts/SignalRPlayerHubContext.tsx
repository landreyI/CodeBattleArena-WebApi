...
export function usePlayerHubConnection() {
    return useContext(SignalRContext);
}

// Хук для подписки на событие
export function usePlayerHubEvent<TArgs extends any[] = any[]>(
    event: string,
