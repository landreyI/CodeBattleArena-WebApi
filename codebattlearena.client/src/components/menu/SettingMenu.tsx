...
interface Props {
    ...
    handleDelet?: (e: any) => void;
}

export function SettingMenu({ setShowEdit, handleDelet }: Props) {
    ...
    return (
        <GenericDropdownMenu
            ...
            menuLabel="Setting"
            actions={[
                ...(setShowEdit ? [{ label: "Edit", onClick: setShowEdit, shortcut: "⌘E" }] : []),
                ...(handleDelet ? [{ label: "Delete", onClick: handleDelet, shortcut: "⨉D" }] : []),
            ]}
        />
    );
}
